            ...
            var requestData = new
            {
                ...
                messages = new[]
                {
                    new {
                        //Ai'nin rolü
                        role = "system",
                        content = "Sen bir restaurant için yemek önerilerini yapan bir yapay zeka aracısın.Amacın kullanıcı tarafından girilen malzemelere göre yemek tarifinde bulunmak"
                    },
                    new
                    {
                        //Kullanıcının rolü
